        ...
        if(Option=="1") {
            ...
            if(password=="123") {
                while(true) {
                    ...
                    if(sellerOption == "1") addFruit();
                    else if(sellerOption =="2") updateFruit();
                    else if(sellerOption =="3") deleteFruit();
                    else if(sellerOption =="4") viewInventory();
                    else if(sellerOption =="5") checkLowStock();
                    else if(sellerOption =="6") sortByPrice();
                    else if(sellerOption =="7") restockFruit();
                    else if(sellerOption =="8") clearProducts();
                    else if(sellerOption =="9") calculateTotalValue();
                    else if(sellerOption =="10")break;
                }
            }
        }
        else if(Option=="2") {
            while(true) {
                ...
                if(buyerOption == "1") viewFruits();
                else if(buyerOption == "2") searchFruitBuyer();
                else if(buyerOption == "3") buyFruit();
                else if(buyerOption == "4") sortBuyer();
                else if(buyerOption == "5") cheapestFruit();
                else if(buyerOption == "6") expensiveFruit();
                else if(buyerOption == "7") checkAvailability();
                else if(buyerOption == "8") billHistory();
                else if(buyerOption == "9") suggestAlternatives();
                else if(buyerOption == "10") break;
            }
        }
    }
    return 0;
